    ...
    <div className="flex gap-3 mt-5 md:gap-[105px] max-md:flex-col">
      <div className="flex-1">
        <textarea
          ...
          className="bg-white w-full min-h-[250px] max-h-[500px] text-black text-[20px] rounded p-[10px] "
        ></textarea>
      </div>
      ...
      <div className="flex-1 relative">
        <textarea
          ...
          className="text-gray-300 w-full min-h-[250px] max-h-[500px] text-[20px] rounded p-[10px] bg-[#59595c]  "
        ></textarea>
